  ...
  (function($) {
    $.fn.NCS = function(options) {
      ...
      function main(elem) {
        ...
        $parent.find("a.NCS.button.plus").click(function() {
        ...
        $parent.find("a.NCS.button.minus").click(function() {
          $category = $(this).attr("category");
          if (options.categoryValues[$category] > options.minValue) {
            options.categoryValues[$category]--;
            $num = options.categoryValues[$category];
        ...
        function clearValues() {
          $values = $parent("div.NCS.value").each(function() {
            $value = $(this);
            $value.text(options.categoryValues[$value.attr("category")]);
          });

          $parent("a.NCS.button.minus").addClass("inactive");
        }
